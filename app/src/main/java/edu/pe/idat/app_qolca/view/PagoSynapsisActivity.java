...
import edu.pe.idat.app_qolca.databinding.ActivityPagoSynapsisBinding;


public class PagoSynapsisActivity extends AppCompatActivity {
    ActivityPagoSynapsisBinding binding;
    private SynapPayButton paymentWidget;
    private FrameLayout synapForm;
    private Button synapButton;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        binding = ActivityPagoSynapsisBinding.inflate(getLayoutInflater());
        ...
        synapButton=binding.synapButton;
        ...
        Button startPayment=binding.startPaymentButton;
    ...
    private void startPayment(){
        ...
        SynapPayButton.setListener(new EventHandler() {
            ...
            public void onEvent(SynapPayButton.Events event) {
                ...
                switch (event){
                    case START_PAY:
                        paymentButton=binding.synapButton;
