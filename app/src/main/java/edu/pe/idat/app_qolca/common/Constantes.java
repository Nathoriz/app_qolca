...
public class Constantes {
    ...
    public static final String URL_API_USUARIO_CREAR="http://"+ipv+":8050/usuario/crearCuenta";
    ...
    public static final String URL_API_PRODUCTO_BUSCAR=" http://"+ipv+":8050/producto/buscar?nombreOrmarca=";
